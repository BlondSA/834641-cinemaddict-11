...
render(siteMainElement, Object(_components_site_menu_js__WEBPACK_IMPORTED_MODULE_1__["createMenuTemplate"])(), `beforeend`);
// Статистика
...
for (let i = 0; i < FILM_COUNT; i++) {
  render(siteFilmListContainerElement, Object(_components_film_card_js__WEBPACK_IMPORTED_MODULE_6__["createFilmCardTemplate"])(), `beforeend`);
}
...
for (let i = 0; i < TOP_FILM_COUNT; i++) {
  render(siteTopFilmsElement, Object(_components_film_card_js__WEBPACK_IMPORTED_MODULE_6__["createFilmCardTemplate"])(), `beforeend`);
}
...
for (let i = 0; i < MOST_COMMENT_FILM_COUNT; i++) {
  render(siteMostCommentsFilmElement, Object(_components_film_card_js__WEBPACK_IMPORTED_MODULE_6__["createFilmCardTemplate"])(), `beforeend`);
}
...
render(siteFooterElement, Object(_components_detail_film_js__WEBPACK_IMPORTED_MODULE_11__["createFilmDetailTemplate"])(), `afterend`);
